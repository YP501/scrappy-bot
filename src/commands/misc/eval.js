...
const info = new SlashCommandBuilder()
    .setName('eval')
    .setDescription('Execute any piece of JavaScript code from the client scope')
    ...
    .addStringOption((option) => option.setName('code').setDescription('Put the JavaScript code you want executed here').setRequired(true));
